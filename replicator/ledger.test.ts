...
describe('registerGene', () => {
  test('creates a gene with a born event and default threshold', () => {
    const l = registerGene(emptyLedger(), 'replicator:meditate', 'preexisting', '2026-08-14T03:00:00Z')
  ...
  test('is idempotent — registering the same key twice does not reset it', () => {
    let l = registerGene(emptyLedger(), 'foo:bar', 'inward', '2026-08-14T03:00:00Z')
    l = recordInvocation(l, 'foo:bar', '2026-08-14', 3)
    l = registerGene(l, 'foo:bar', 'inward', '2026-08-15T03:00:00Z')
  ...
  test('honors the core option', () => {
    const l = registerGene(emptyLedger(), 'cronjobs:cronjob', 'preexisting', '2026-08-14T03:00:00Z', { core: true })
  ...
  test('does not mutate the input ledger', () => {
    ...
    registerGene(before, 'foo:bar', 'inward', '2026-08-14T03:00:00Z')
