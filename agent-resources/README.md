...
| create-mcp-servers | `/agent-resources:create-mcp-servers` | Expert guidance for building MCP servers for Claude/Pi integrations (Python/TypeScript), including bidirectional channel communication with OMP |
