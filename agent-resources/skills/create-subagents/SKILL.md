...
For XML structure principles and token efficiency details, see ${CLAUDE_PLUGIN_ROOT}/skills/create-agent-skills/references/use-xml-tags.md - the same principles apply to subagents.
</critical_rule>
</subagent_xml_structure>
